...
const resources = {
  zh: {
    translation: {
      'Shortcut to open this app': '打开MyAwesomeApp的快捷键',
      Settings: '设置',
      'Startup page': '启动页面',
      'Chat style': '会话风格',
      ...
      'More providers in All-In-One mode': '在All-In-One模式下使用更多chatprovider（三合一、四合一）',
      'Chat history full-text search': '全文搜索聊天记录',
      'Customize theme': '自定义主题',
      'More features in the future': '享受未来所有功能更新',
      'Support the development of MyAwesomeApp': '支持MyAwesomeApp的开发',
      'Enjoy MyAwesomeApp? Give us a 5-star rating!': '喜欢MyAwesomeApp吗？给我们个5星好评吧！',
      'Write review': '去评价',
      ...
      'You have opened MyAwesomeApp {{openTimes}} times, consider unlock all features?':
        '哇！你已经打开MyAwesomeApp {{openTimes}}次了，是否要解锁全部功能呢？🥺',
  ...
  in: {
    translation: {
      ...
      'More providers in All-In-One mode': 'Lebih banyak provider dalam mode All-In-One',
      ...
      'Support the development of MyAwesomeApp': 'Dukung pengembangan MyAwesomeApp',
      'Enjoy MyAwesomeApp? Give us a 5-star rating!': 'Menikmati MyAwesomeApp? Beri kami rating 5 bintang!',
      ...
      'You have opened MyAwesomeApp {{openTimes}} times, consider unlock all features?':
        'Wow! Anda telah membuka MyAwesomeApp sebanyak {{openTimes}} kali, pertimbangkan untuk membuka semua fitur?',
