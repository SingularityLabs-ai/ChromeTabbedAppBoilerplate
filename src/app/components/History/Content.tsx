...
const HistoryContent: FC<{ providerId: ProviderId; keyword: string }> = ({ providerId, keyword }) => {
  const historyQuery = useSWR(`history:${providerId}`, () => loadHistoryMessages(providerId), { suspense: true })
